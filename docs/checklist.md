...
- [x] System prompt: *(model draws on general knowledge — tightened constraints)*
- [x] Question generation: *(produces yes/no questions — added open-ended instruction)*
- [x] Answer evaluation: *(score too generous — adjusted scoring rubric)*
- [x] Query rewrite: *(over-abbreviates — tested with longer queries)*
