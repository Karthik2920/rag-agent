...
6. You MUST NOT use phrases like "we can infer", "it likely means", "generally", or any assumption beyond the given context.
...
- Answer directly and confidently (no phrases like "it appears", "it seems", etc.)
